...
const SettingsItem = ({icon,title,onPress, textStyle, showArrow =true}:SettingsItemProps)=>{
  return (
    <TouchableOpacity onPress={onPress} className='border-red-600 flex flex-row items-center justify-between py-3'>
      <View className='border-blue-300 flex flex-row items-center gap-3'>
