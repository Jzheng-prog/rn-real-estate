...
const SignIn = () => {
  ...
  return (
    <SafeAreaView className='bg-white h-full border'>
      <ScrollView contentContainerClassName='h-full'>
        ...
        <View className='px-10'>
          ...
          <Text className='text-3xl font-rubik-bold text-center mt-2'>Lets Get You Closer to {"\n"}
          ...
          >
            <View className='flex flex-row items-center justify-center'>
              ...
              <Text className='mx-4 font-rubik-medium text-black-300 text-lg'>Continue with Google</Text>
            </View>
          </TouchableOpacity>
        </View>
      </ScrollView>
